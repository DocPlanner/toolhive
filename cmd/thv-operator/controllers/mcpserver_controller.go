...
func (*MCPServerReconciler) buildSessionRedisCredentialEnvVars(mcpServer *mcpv1beta1.MCPServer) []corev1.EnvVar {
	if mcpServer.Spec.SessionStorage == nil ||
		mcpServer.Spec.SessionStorage.Provider != mcpv1beta1.SessionStorageProviderRedis {
		return nil
	}
...
func (r *MCPServerReconciler) deploymentForMCPServer(
	...
	// Extract scheduling constraints from the user PodTemplateSpec so the proxy
	// deployment is scheduled alongside the MCP server pods it manages.
	...
	// Mount Redis credential secrets when session storage provider is Redis.
...
func mcpServerStatusURL(mcpServer *mcpv1beta1.MCPServer, serviceName string) string {
...
func isLegacyMCPServerResourceFor(obj client.Object, m *mcpv1beta1.MCPServer) bool {
	if obj == nil || m == nil {
		return false
	}
