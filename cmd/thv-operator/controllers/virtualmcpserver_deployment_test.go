...
func TestBuildRedisCredentialEnvVars_GlobalDefault(t *testing.T) {
	...
	r := &VirtualMCPServerReconciler{}
	got := r.buildRedisCredentialEnvVars(vmcp)
...
func TestBuildRedisCredentialEnvVars_NonRedisProviderNotOverriddenByGlobal(t *testing.T) {
	t.Setenv("TOOLHIVE_DEFAULT_REDIS_ADDR", "global-redis:6379")
...
func TestBuildRedisCredentialEnvVars_NilWhenNoGlobal(t *testing.T) {
