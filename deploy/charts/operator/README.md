...
| operator.pdb | object | `{"enabled":false,"maxUnavailable":1}` | PodDisruptionBudget for the operator |
| operator.pdb.enabled | bool | `false` | Enable PDB for the operator |
| operator.pdb.maxUnavailable | int | `1` | Maximum number of pods that can be unavailable during disruption |
